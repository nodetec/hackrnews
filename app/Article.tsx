  ...
  return (
    <li className="py-4 px-4 ring-1 ring-gray-500 hover:bg rounded-md ">
      <div className="flex flex-row gap-1 items-center">
        <span className="font-bold mr-4 txt-color flex items-center flex-row ring-1 ring-primary rounded">
          <span className="mx-2">{index}</span>
          <button className="p-2 bg-primary txt-color">
            <HandThumbUpIcon className="h-4 w-4" />
          </button>
        </span>
        <span>{title}</span>
        <span className="cursor-pointer text-[0.6rem] text-subtitle  font-semibold uppercase flex items-center m-3">
